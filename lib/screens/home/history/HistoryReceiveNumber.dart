...
class HistoryReceiveNumber extends StatefulWidget {
  HistoryReceiveNumber(
      {super.key,
      required this.MyUid,
  ...
  @override
  State<HistoryReceiveNumber> createState() => _HistoryReceiveNumberState();
}

class _HistoryReceiveNumberState extends State<HistoryReceiveNumber> {
  List<String> docIDs = [];
  bool isLoaded = false;
  ...
  Widget _HistoryItems({required String documentId, required int index}) {
    CollectionReference users =
        FirebaseFirestore.instance.collection('Receive ${widget.MyUid}');
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        ...
                        child:
                            Image.asset(data["Image"] ?? "images/profile.png"),
                      ),
