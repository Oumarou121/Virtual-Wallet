...
class HistoryReceive extends StatefulWidget {
  HistoryReceive({super.key, this.MyUid, required this.userData});
  var MyUid;
  var userData;
  @override
  State<HistoryReceive> createState() => _HistoryState();
}

class _HistoryState extends State<HistoryReceive> {
