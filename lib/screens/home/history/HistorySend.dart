...
class HistorySend extends StatefulWidget {
  HistorySend({super.key, this.MyUid, required this.userData});
  var MyUid;
  var userData;

  @override
  State<HistorySend> createState() => _HistoryState();
}

class _HistoryState extends State<HistorySend> {
              ...
              child: ListTile(
                ...
                leading: CircleAvatar(
                  ...
                  child: Icon(
                    ...
                    // color: SwicthColor(userData: widget.userData),
                  ),
                ),
