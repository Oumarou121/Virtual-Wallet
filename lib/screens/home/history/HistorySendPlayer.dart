...
class HistorySendPlayer extends StatefulWidget {
  HistorySendPlayer(
      {super.key,
      this.MyUid,
  ...
  var userData;
  @override
  State<HistorySendPlayer> createState() => _HistorySendPlayerState();
}

class _HistorySendPlayerState extends State<HistorySendPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   backgroundColor:SwicthColor(userData: userData)
