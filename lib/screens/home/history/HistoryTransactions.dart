...
class HistoryTransactions extends StatefulWidget {
  HistoryTransactions({super.key, this.MyUid, required this.userData});
  var MyUid;
  var userData;
  @override
  State<HistoryTransactions> createState() => _HistoryState();
}

class _HistoryState extends State<HistoryTransactions> {
  ...
  void _destory({required index}) async {
    await FirebaseFirestore.instance
        .collection('Transactions ${widget.MyUid}')
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          print('Transactions ${widget.MyUid}');
          var collection = FirebaseFirestore.instance
              .collection('Transactions ${widget.MyUid}')
              .orderBy("order", descending: true);
          _incrementCounter(collection: collection);
            ...
            child: Card(
              ...
              child: ListTile(
                ...
                leading: CircleAvatar(
                  ...
                  child: Image.asset(
                      items[index]["Image"] ?? "images/profile.png"),
                ),
