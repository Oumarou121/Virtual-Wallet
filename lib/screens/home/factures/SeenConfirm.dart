...
class SeenConfirm extends StatefulWidget {
  SeenConfirm({super.key, this.Numero});

  var Numero;

  @override
  State<SeenConfirm> createState() => _SeenConfirmState();
}

class _SeenConfirmState extends State<SeenConfirm> {
  String error = '';
  String Uid = 'oP8QgL002XUPSkKdBiVEAdCLPUi2';
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Container(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  wPushReplaceTo2(
                      context, Seen(userData: userData, return1: true));
                }))
      ]),
    );
  }
