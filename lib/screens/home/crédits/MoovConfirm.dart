...
class MoovConfirm extends StatefulWidget {
  MoovConfirm({super.key, required this.Numero, required this.Amount});
  var Amount;
  var Numero;

  @override
  State<MoovConfirm> createState() => _AirtelConfirmState();
}

class _AirtelConfirmState extends State<MoovConfirm> {
  String error = '';
  String Uid = 'pjVJm6imobf7D1kXz8EOS3flMOP2';
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Container(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  wPushReplaceTo2(
                      context, Moov(userData: userData, return1: true));
                }))
      ]),
    );
  }
