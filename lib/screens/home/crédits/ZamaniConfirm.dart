...
class ZamaniConfirm extends StatefulWidget {
  ZamaniConfirm({super.key, required this.Numero, required this.Amount});
  var Amount;
  var Numero;

  @override
  State<ZamaniConfirm> createState() => _ZamaniConfirmState();
}

class _ZamaniConfirmState extends State<ZamaniConfirm> {
  String error = '';
  String Uid = 'i8VBMt9JTnTm0CLx1YNu4t6E4jQ2';
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Container(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  wPushReplaceTo2(
                      context, Zamani(userData: userData, return1: true));
                }))
      ]),
    );
  }
