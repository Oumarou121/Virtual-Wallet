...
class NigerTelecomsConfirm extends StatefulWidget {
  NigerTelecomsConfirm({super.key, required this.Numero, required this.Amount});
  var Amount;
  var Numero;

  @override
  State<NigerTelecomsConfirm> createState() => _NigerTelecomsConfirmState();
}

class _NigerTelecomsConfirmState extends State<NigerTelecomsConfirm> {
  String error = '';
  String Uid = 'XnnnuHP1l4gSaNRon2QJ3Blor8H3';
...
// ignore: unused_field
  ...
  Future<void> SuccesAction(
    ...
    // await colllection1.doc().set(data);
            ...
            child: IconButton(
                ...
                onPressed: () {
                  wPushReplaceTo2(context,
                      NigerTelecoms(userData: userData, return1: true));
                }))
      ]),
    );
  }
