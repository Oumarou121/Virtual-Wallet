...
import 'package:virtual_wallet_2/screens/home/cr%C3%A9dits/NigerTelecomsConfirm.dart';
import 'package:virtual_wallet_2/utils/utils.dart';
import 'package:virtual_wallet_2/widgets/widgets.dart';

class NigerTelecoms extends StatefulWidget {
  NigerTelecoms({super.key, required this.userData, required this.return1});
  var userData;
  final bool return1;
  @override
  State<NigerTelecoms> createState() => _NigerTelecomsState();
}

class _NigerTelecomsState extends State<NigerTelecoms> {
