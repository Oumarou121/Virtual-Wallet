...
class AirtelConfirm extends StatefulWidget {
  AirtelConfirm({super.key, required this.Numero, required this.Amount});
  var Amount;
  var Numero;

  @override
  State<AirtelConfirm> createState() => _AirtelConfirmState();
}

class _AirtelConfirmState extends State<AirtelConfirm> {
  String error = '';
  String Uid = 'NV9YYI5IiiM9SgPJjJqtbetr9Lo1';
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Container(
            ...
            child: IconButton(
                ...
                onPressed: () {
                  wPushReplaceTo2(
                      context, Airtel(userData: userData, return1: true));
                }))
      ]),
    );
  }
